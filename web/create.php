...
<div class ="card text-center">
    <div class="card-body">
        ...
        <form action="save.php" method="POST">
            ...
            <div class="col">
            <input type="text" name="first_name" class="form-control" placeholder="Nombres" autofocus>
            </div>
            ...
            <div class="col">
            <label></label>
            <input type="text" name="gender" class="form-control" placeholder="Ingrese genero" autofocus>
            </div>
